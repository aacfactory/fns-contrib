module github.com/aacfactory/fns-contrib/transports/handlers/pprof
...
require (
	...
	github.com/aacfactory/errors v1.13.5 // indirect
	github.com/aacfactory/fns v1.1.2 // indirect
