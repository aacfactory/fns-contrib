...
require (
	github.com/aacfactory/fns-contrib/authorizations/jwt v0.0.0-20210906015750-0bb8272e7ede
	github.com/aacfactory/fns-contrib/databases/sql v0.0.0-20210906014819-0a652391c625
)

require (
	github.com/aacfactory/configuares v1.2.2 // indirect
	github.com/aacfactory/errors v1.5.0 // indirect
	github.com/aacfactory/fns v0.3.0 // indirect
